...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Orbital benchmark performance under Low-light Conditions.}
...
To prevent the model from overfitting to specific synthetic visual patterns, domain randomisation was applied to each frame. 
